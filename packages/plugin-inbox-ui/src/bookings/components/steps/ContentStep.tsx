    ...
    return (
      <>
        <Flex>
          <FlexItem>
            <FormGroup>
              <ControlLabel required={true}>{__('Booking Name')}</ControlLabel>
              <FormControl
                type="text"
                value={name}
        ...
        <FormGroup>
          <ControlLabel>{__('Booking Image')}</ControlLabel>
          <Uploader
        ...
        <FormGroup>
          ...
          <Description>
            {__('Type in a word to display as the navigation button text')}
          </Description>
          <FormControl
            type="text"
      ...
      <>
        ...
        <FormGroup>
          ...
          <SelectProductCategory
            ...
            placeholder={__('Choose product category')}
          />
        </FormGroup>
        ...
        <FormGroup>
          ...
          <Description>{__('displayBooking')}</Description>
          <FormControl
            type="text"
        ...
        <FormGroup>
          ...
          <Description>{__('selectDetail')}</Description>
          <Select
